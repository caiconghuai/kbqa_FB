...
def get_args():
    ...
    parser.add_argument('--train_file', type=str, default='data/train.subject_type.pt')
    parser.add_argument('--valid_file', type=str, default='data/valid.subject_type.pt')
    parser.add_argument('--test_file', type=str, default='data/test.subject_type.pt')
    parser.add_argument('--type_vocab', type=str,default='../vocab/vocab.type.pt')
    # added for testing
    parser.add_argument('--trained_model', type=str, default='')
    parser.add_argument('--results_path', type=str, default='results')
    parser.add_argument('--write_result', action='store_true', help='write predict results to file or not')
